...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
      <div className="bg-white shadow-2xl rounded-2xl p-6 sm:p-10 max-w-3xl w-full text-center">
        ...
        <Link href="/">
          <button className="mt-10 px-6 sm:px-8 py-3 flex items-center gap-2 mx-auto bg-blue-600 text-white font-semibold rounded-xl shadow hover:bg-blue-700 transition text-base sm:text-lg">
